...
impl KeyButton {
    ...
    pub fn key_type(self) -> KeyType {
        match self {
            ...
            Self::NUM0 => KeyType::Common,
            Self::NUM1 => KeyType::Common,
            Self::NUM2 => KeyType::Common,
            Self::NUM3 => KeyType::Common,
            Self::NUM4 => KeyType::Common,
            Self::NUM5 => KeyType::Common,
            Self::NUM6 => KeyType::Common,
            Self::NUM7 => KeyType::Common,
            Self::NUM8 => KeyType::Common,
            Self::NUM9 => KeyType::Common,
...
impl std::fmt::Display for KeyButton {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let name = match self {
            ...
            Self::OEM_8 => "Right Ctrl, Canadian CSA",
            Self::OEM_102 => "Backslash (bottom-left)",
